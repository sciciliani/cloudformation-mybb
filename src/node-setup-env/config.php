...
$config['database']['write']['hostname'] = 'DATABASE_MASTER_HOST';
$config['database']['write']['username'] = 'DATABASE_USER';
$config['database']['write']['password'] = 'DATABASE_PASSWORD';

$config['database']['read'][0]['hostname'] = 'DATABASE_READ_HOST';
$config['database']['read'][0]['username'] = 'DATABASE_USER';
$config['database']['read'][0]['password'] = 'DATABASE_PASSWORD';

$config['database']['read'][1]['hostname'] = 'DATABASE_READ_HOST_2';
$config['database']['read'][1]['username'] = 'DATABASE_USER';
$config['database']['read'][1]['password'] = 'DATABASE_PASSWORD';
...
$config['memcache']['host'] = 'MEMCACHE_MASTER_HOST';
$config['memcache']['port'] = MEMCACHE_MASTER_PORT;
